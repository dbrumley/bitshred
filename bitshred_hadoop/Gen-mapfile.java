...
public class Gen {
    ...
    public static class Map extends MapReduceBase implements Mapper<LongWritable, Text, IntWritable, BytesWritable> {
        ...
        public void map(LongWritable key, Text value, OutputCollector<IntWritable, BytesWritable> output, Reporter reporter) throws IOException {
...
//        private String inputFile;
        ...
        public void configure(JobConf job) {
            try {
                Configuration conf = new Configuration();
                fs = FileSystem.get(conf);
                writer = new MapFile.Writer(conf, fs, DATA_PATH, IntWritable.class, BytesWritable.class);
            } catch (IOException ioe) {
                System.err.println("Caught exception while getting cached files");
            }
        }
